$(function name() {
    ...
    for (i = 0; i < acc.length; i++) {
        ...
        acc[i].onclick = function () {
            ...
            var courseAccordionActive = document.getElementsByClassName("accordion__wrapper active");
    ...
    //     var init = function () {
    //         var element = document.getElementsByClassName('accordeon__btn');
    ...
    //         var elementRemovedClass = document.getElementsByClassName('accordeon__btn'),
    //             elementLength = elementRemovedClass.length;

    //         // В цикле проходим по всем и удаляем класс
    //         for (var i = 0; i < elementLength; i++) {
    //             elementRemovedClass[i].classList.remove("accordeon__btn");
    //         }
    //     };
